...
he would not have been victorious under any standard voting method, and notably,
he was not the Borda winner. His opponent in the second round, Fernando Haddad,
was a Condorcet loser among the top four candidates and would not have defeated
Bolsonaro under any positional voting method. The third-place candidate, Ciro
Gomes, had a slight positional advantage over Bolsonaro, with the potential to
beat him in \(53\%\) of the positional voting methods. Ciro's advantage was
especially pronounced in methods that emphasized rejection. This case highlights
a partial conflict between typical evaluative positions, harking back to the
historic Borda-Condorcet debate.
...
party at the time. Second, on September 6, 2018, a month before the first round, there
...
October 2, 2018, less than a week before the first round (October 7, 2018).
DataFolha, an independent research institute highly esteemed and trusted by
...
did this survey. One question, in particular, is the only variable in our
analysis: pairwise comparisons between the 4 top candidates. The pairwise
comparisons were: Alckmin \(\times\) Bolsonaro, Alckmin \(\times\) Ciro, Alckmin
\(\times\) Haddad, Bolsonaro \(\times\) Ciro, Bolsonaro \(\times\) Haddad,
Haddad \(\times\) Ciro. There was no indifference option. With these strict
comparisons for all survey respondents it is possible to reconstruct their full 4-top ranking.
...
implicit when we removed candidates, is not necessarily valid with coalitions \parencite{kaminski2001coalitional},
