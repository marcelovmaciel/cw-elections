...
\parencite{Bednare2113843118, przeworski2019crises, chiopris2021wolf, ,
  tarko2014institutional}. Given their centrality to the input-output relation
between society and the state, electoral institutions naturally figure among the
set of such institutions under scrutiny \parencite{Wange2021systems}, and a
strand of the literature on collective choice has wondered whether the current
electoral victories of divisive candidates have not been an effect of
informationally poor decision procedures \parencite{potthoff2021condorcet,
  kurrild2018trump, woon2020trump}. This paper shows, however, that in 2018
presidential election in Brazil the election of a polarizing candidate, Jair
Messias Bolsonaro, was not simply an artifact of the decision procedure. In
spite of that, neither would he have won under any reasonable voting method. We
demonstrate that in this case there is a partial conflict between typical
evaluative positions, harking back to the Borda vs Condorcet debate.
...
% Even if attention is restricted to a single electoral rule, the aggregation
% procedure that transforms ballots into a choice of a candidate,
% point of view, the decision procedures respect differing axiological criteria
% such as monotonicity, neutrality, anonymity and manipulability
% \parencite{nurmi1999voting, felsenthal2011review}. From a dynamic point of view,
% politicians and voters continuously adapt to the rule in a system of feedbacks
% between the state and society \parencite{Wange2021systems}.
 % Both dimensions are intimately
% connected. On the one hand, political actors regularly shift the level of
% dispute from within the rules of the game to disputes about the rules themselves
...
% undesirable properties of the status quo.
